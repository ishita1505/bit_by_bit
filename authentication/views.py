...
def signup(request):
    if request.method=="POST":
        ...
        messages.success(request,"Your account has been succesfully created . We have also sent you a confirmation email, please confirm your email account in order to activate your account")
